...
gulp.task('watch', function() {
    gulp.watch(assets.js.paths, async=>{
        gulp.src(assets.js.paths)
        .pipe(gulp.dest(settings.destFolder + '/js/'))
    });
    gulp.watch(assets.css.paths, async=>{
        gulp.src(assets.css.paths)
        .pipe(gulp.dest(settings.destFolder + '/css/'))
    });
    gulp.watch(assets.image.paths, async=>{
        gulp.src(assets.image.paths)
        .pipe(gulp.dest(settings.destFolder + '/images/'))
    });
});
...
gulp.task('default', gulp.series('watch', 'js', 'css', 'images', 'fonts', 'html'));
